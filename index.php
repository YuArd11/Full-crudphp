                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <a href="tambah-barang" class="btn btn-primary btn-sm mb-2"><i class="fas fa-plus"></i> Tambah Barang</a>
                                            ...
                                            <?php foreach ($data_barang as $barang): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <img alt="barcode"
                                                            src="barcode.php?codetype=Code128&size=20&text='<?= $barang['barcode']; ?>'&print=true" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="text-center" width="20%">
                                                        <a href="ubah-barang.php?id_barang=<?= $barang['id_barang']; ?>"
                                                            class="btn btn-info"><i class="far fa-edit"></i> Edit</a>
