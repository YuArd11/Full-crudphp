...
//cek tombol login di tekan
if(isset($_POST['login'])){
  //ambil data user dan pass
...
<html lang="en">
  <head>
    ...
    <title>Login Admin Sistem</title>
...
<main class="form-signin">
  <form action="" method="POST">
    ...
    <div class="form-floating">
      <input type="text" name="username" class="form-control" id="floatingInput" placeholder="Masukan Username..." required>
    ...
    <p class="mt-5 mb-3 text-muted">CopyRight &copy;Yu <?=date('Y') ?></p>
  </form>
</main>
